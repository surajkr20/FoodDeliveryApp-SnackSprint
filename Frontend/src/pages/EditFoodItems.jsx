...
const EditFoodItems = () => {
  ...
  useEffect(()=>{
    const fetchCurrentFoodItems = async ()=>{
      setLoading(true)
      try {
        ...
        console.log("fetchCurrentFoodItems error",error);
        setLoading(false)
      }
    }
    fetchCurrentFoodItems();
  }, [itemId])
    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-br from-orange-50 to-white">
      ...
      >
        ...
        <div className="w-full flex flex-col items-center gap-1">
          ...
          <h2 className="text-xl font-semibold font-serif">Edit Food</h2>
        </div>
